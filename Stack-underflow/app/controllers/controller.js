app.controller("StackController", function ($scope, StackService) {
    ...
    $scope.people = StackService.getNames();
    ...
    console.log(questionTag("functions"))
})